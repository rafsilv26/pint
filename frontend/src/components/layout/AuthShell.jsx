...
export default function AuthShell({ title, subtitle, children, footer }) {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 items-center justify-center overflow-hidden bg-gradient-to-br from-brand-dark via-brand to-brand-accent lg:flex">
        <div className="text-center text-white">
          <Logo className="mx-auto h-12 w-auto" textClassName="text-5xl" />
          <p className="mt-3 text-white/70">Plataforma de Badges</p>
        </div>
      </div>
